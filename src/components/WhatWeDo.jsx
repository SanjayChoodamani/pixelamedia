...
const WhatWeDoCard = ({icon, title, description, link, index, isVisible}) => {
    return (
        <div className={`bg-[#1a1a1a] p-6 rounded-lg transition-all duration-700 ease-out hover:shadow-2xl hover:shadow-[#00B78E]/30 border border-gray-800 text-center flex flex-col items-center transform group ${
